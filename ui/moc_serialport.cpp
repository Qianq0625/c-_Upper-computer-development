...
QT_MOC_LITERAL(3, 25, 11) // "handle_data"

    },
    "serialPort\0receive_data\0\0handle_data"
};
...
void serialPort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&serialPort::receive_data)) {
                *result = 0;
                return;
            }
        }
